# Operator Quickstart — Natural gas extraction

Shortest path from clone to a verified local dry-run for **ISIC 0620** (`cloud-itonami-isic-0620`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0620.git
cd cloud-itonami-isic-0620
```
...
- Blueprint governor key: `gas-well-safety-governor`
- Likely source path: `gasfield.governor.cljc`
